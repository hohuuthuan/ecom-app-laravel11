...
@section('content')
<div class="container my-4 py-2" data-page="cart">
  <div class="d-flex justify-content-between align-items-center mb-3">
    <h1 class="h4 m-0"><i class="bi bi-cart-fill me-2"></i>Giỏ hàng</h1>
    <a class="btn btn-outline-primary" href="{{ route('home') }}"><i class="bi bi-arrow-left"></i> Tiếp tục mua sắm</a>
  </div>
  ...
  <div class="row g-3">
    <!-- LEFT: Items -->
    <div class="col-lg-8">
      <div class="card p-3 items-section">
    ...
    <!-- RIGHT: Summary -->
    <div class="col-lg-4">
      <div class="card p-3 summary-section">
        <div class="summary-title h5 mb-2">Tóm Tắt Đơn Hàng</div>
        <div id="selectedCount" class="badge bg-primary mb-3 selected-count">Đã chọn 0 sản phẩm</div>
