        ...
        <div class="checkout-form">
          <div class="form-section">
            ...
            <div class="alert alert-warning mt-3 mb-0">
              Bạn cần cập nhật đầy đủ <strong>họ và tên</strong> và <strong>số điện thoại</strong> để đặt hàng.
              <button
                type="button"
                class="address-add-btn btn btn-sm btn-outline-primary"
                data-bs-toggle="modal"
...
{{-- MODAL: CHỈNH SỬA THÔNG TIN CÁ NHÂN (COPY TỪ profileOverview) --}}
<div
  class="modal fade"
  id="editProfileModal"
  tabindex="-1"
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content profile-modal">
      <form method="POST" action="{{ route('user.profile.info.update') }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <input type="hidden" name="redirect_to" value="{{ route('checkout.page') }}">
...
@if (session('checkout_open_profile_modal'))
<script>
