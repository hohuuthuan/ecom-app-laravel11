          ...
          <div class="col-lg-10">
            <div class="row g-3">
              <div class="col-md-4">
                ...
                <input type="text" class="form-control" id="ac_name" name="name" value="{{ old('name') }}" placeholder="Nhập họ tên" required>
              ...
              <div class="col-12">
                ...
                <textarea id="ac_address" name="" class="form-control" rows="3" placeholder="Nhập địa chỉ"></textarea>
              ...
              <div class="col-md-6 select2CustomWidth">
                ...
                <select id="ac_status" name="status" class="form-select setupSelect2" data-placeholder="Chọn trạng thái" required>
                  ...
                  <option value="BAN" {{ old('status')==='BAN'    ? 'selected' : '' }}>Khóa</option>
                </select>
