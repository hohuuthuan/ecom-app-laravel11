                ...
                <tr>
                  ...
                  <td class="text-center">
                    <button type="button"
                      ...
                      data-avatar="{{ Storage::url('avatars/'.($user->avatar ?: 'base-avatar.jpg')) }}"
...
<script id="seed"
  ...
  data-avatar='@json(Storage::url("avatars/base-avatar.jpg"))'>
</script>

<script src="{{ asset('js/admin/account-tab.js') }}"></script>
