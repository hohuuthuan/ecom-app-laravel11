            ...
            <form method="POST" action="{{ route('login') }}">
              ...
              <div class="mb-3">
                ...
                <div class="input-group">
                  ...
                  <button type="button" class="btn btn-outline-secondary" data-toggle-password data-target="#loginPassword" aria-label="Hiện/ẩn mật khẩu">
