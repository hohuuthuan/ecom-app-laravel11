      ...
      <div class="card shadow-sm table-in">
        ...
        <div class="card-body">
          ...
          <div class="table-responsive">
              <table id="categoryTable" class="table table-bordered table-striped align-middle customTableAdmin">
...
@push('scripts')
  <script src="{{ asset('js/catalog/catalog-tabs.js') }}"></script>
  <script src="{{ asset('js/catalog/modal-errors.js') }}"></script>
  <script src="{{ asset('js/ui/confirm-modal.js') }}"></script>
  <script src="{{ asset('js/catalog/brands.js') }}"></script>
  <script src="{{ asset('js/catalog/categories.js') }}"></script>
@endpush
