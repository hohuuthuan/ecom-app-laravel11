...
<section class="py-4">
  <div class="container">
    <div class="page-header">
      ...
      <h1 class="pageTitle">SẢN PHẨM ĐÃ XEM</h1>
    </div>

    @if($products->isEmpty())
    <div
      id="recently-viewed-list-wrapper"
      class="recently-viewed-empty text-center"
      data-list-url="{{ route('recentlyViewed') }}">
      <div class="recently-viewed-empty-icon mb-3">
        <i class="bi bi-clock-history"></i>
      </div>

      <h5 class="mb-2">Chưa có sản phẩm</h5>
      <p class="text-muted mb-3">
        Bạn chưa xem qua sản phẩm nào. Hãy khám phá thêm sách ở trang chủ.
      </p>
    </div>

    @else
    {{-- WRAPPER CHO SẢN PHẨM VÀ PHÂN TRANG --}}
    <div
      id="recently-viewed-list-wrapper"
      data-list-url="{{ route('recentlyViewed') }}">
      ...
      <div class="d-flex justify-content-center align-items-center mt-3 recently-viewed-pagination" id="pagination-links">
